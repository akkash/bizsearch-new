-- 5K Car Care Franchise Locations Insert
-- Run this AFTER running 007_5k_car_care_simple.sql
-- This adds all the branch locations for 5K Car Care franchise
...
BEGIN
  ...
  -- Trichy Branches (Headquarters region)
  ...
  RAISE NOTICE '✅ Successfully inserted 5K Car Care locations!';
...
SELECT 
  ...
  COUNT(*) FILTER (WHERE status = 'looking_for_franchise') as available_territories
