...
export function FranchiseCard({
  ...
  return (
    <article
      className={cn(
        "group border-2 border-foreground bg-card p-6 flex flex-col cursor-pointer transition-colors",
        className
      )}
      ...
      <div className="flex items-start justify-between gap-3 mb-8">
        <div className="flex items-start gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs uppercase tracking-widest opacity-60 mt-1 line-clamp-1">
        ...
        <div className="flex gap-1 shrink-0">
          ...
          >
            <Heart className={cn("h-4 w-4", isSaved && "fill-foreground")} />
          </Button>
        </div>
      </div>

      <div className="mt-auto">
        <div className="text-3xl md:text-4xl font-display font-bold font-mono tabular-nums tracking-tight leading-none mb-1">
          {investmentLabel}
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 border-t-2 border-foreground pt-4 mb-6 text-sm">
          <div>
            <div className="text-xs uppercase tracking-widest opacity-60 mb-1">Fee</div>
          ...
          {royalty != null && (
            <div>
              <div className="text-xs uppercase tracking-widest opacity-60 mb-1">Royalty</div>
              <div className="font-bold font-mono tabular-nums">{royalty}%</div>
            </div>
          )}
          {territories.length > 0 && (
            <div>
              <div className="text-xs uppercase tracking-widest opacity-60 mb-1">Territory</div>
        ...
        {verified && (
          <div className="flex items-center gap-1 text-xs uppercase tracking-widest mb-4">
